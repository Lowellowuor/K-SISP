...
import { Brain, Filter, LayoutGrid, RefreshCw, Settings, Maximize2, Minimize2, Eye, EyeOff, ChevronRight } from 'lucide-react';

const AnalyticsDashboardControls = ({
  activeZone,
  setActiveZone,
  viewMode,
  setViewMode,
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-4">
          <div className={`p-3 rounded-xl ${
            ...
            <Brain className={`h-6 w-6 ${darkMode ? 'text-emerald-400' : 'text-emerald-600'}`} />
          </div>
          <div>
            ...
            <p className={`text-sm ${darkMode ? 'text-emerald-300/70' : 'text-emerald-600/70'}`}>
              Kibera Sanitation Research & Predictive Modeling
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center space-x-2">
            <ChevronRight className={`h-4 w-4 ${darkMode ? 'text-emerald-300' : 'text-emerald-600'}`} />
...
export default AnalyticsDashboardControls;